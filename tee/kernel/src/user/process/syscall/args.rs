...
use self::pointee::{
    AbiAgnosticPointee, Custom, Pointee, PrimitivePointee, Timespec32, WritablePointee,
};
...
impl pointee::Pointee for DirEntry {}

impl WritablePointee<Custom> for DirEntry {
